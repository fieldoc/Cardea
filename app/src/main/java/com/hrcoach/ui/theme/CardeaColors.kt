...
val DarkCardeaColors = CardeaColors(
    ...
    textQuaternary = CardeaTextQuaternary,
    amber = CardeaAmber,
    gradient = CardeaGradient,
    ctaGradient = CardeaCtaGradient,
    ctaGradient3Stop = CardeaCtaGradient3Stop,
...
val LightCardeaColors = CardeaColors(
    ...
    glassBorderStrong = LightGlassBorder,
    ...
    textQuaternary = CardeaLightTextTertiary,
    amber = CardeaAmber,
    gradient = CardeaGradient,
    ctaGradient = CardeaCtaGradient,
    ctaGradient3Stop = CardeaCtaGradient3Stop,
